  ...
  try {
    ...
    const { data: conversa, error: errConv } = await supabase
      ...
      .select(`
        ...
        aguardando_cliente_prazo_ate,
        aguardando_cliente_prazo_origem,
        aguardando_cliente_prazo_desde,
        aguardando_cliente_nivel,
