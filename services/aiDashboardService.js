...
const { AI_MODEL, clampDays, chunkArray, normalizeOpenAiUsage, addUsage } = require('./aiDashboard/constants')
const { stringifyDataForPrompt } = require('./aiDashboard/promptPayload')
const { IntentSchema } = require('./aiDashboard/intentSchema')
const {
  LEXICO_FINANCEIRO,
  LEXICO_COMERCIAL_COMPRA,
  LEXICO_OPERACIONAL,
} = require('./aiDashboard/lexicos')
const {
  expandTermosForSearch,
  textoCasaTermoRobusto,
  filtrarConversasIndividuais,
} = require('./aiDashboard/searchText')
const {
  buildMsgsByConv,
...
} = require('./aiDashboard/firstResponse')
const {
...
} = require('./aiDashboard/sanitizers')
const {
  RECORTE_TZ,
  calendarKeyInTz,
  calendarKeyNowSp,
...
} = require('./aiDashboard/time')
const {
  aplicarHeuristicasDeterministicas,
  enrichTermosBuscaFromIntent,
} = require('./aiDashboard/heuristics')
const { resolveUsuarioCandidates, resolveClienteCandidates } = require('./aiDashboard/resolveEntities')
