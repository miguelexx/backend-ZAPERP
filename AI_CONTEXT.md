...
Ponteiro curto. **Não** é a fonte normativa.
...
Regras: isolamento por `company_id`; WhatsApp = UltraMSG; código e migrations prevalecem; não executar migration, deploy, envio real, commit ou push sem autorização explícita.
