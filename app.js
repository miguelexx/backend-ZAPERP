...
const whapiTriageRoutes = require('./routes/whapiTriageRoutes')
...
app.use('/whapi/triagem', apiLimiter, whapiTriageRoutes)
...
api.use('/whapi/triagem', whapiTriageRoutes)
...
if (hasFrontendDist) {
  ...
  // Nunca injetar location.reload() no SPA. AUTO_REFRESH_MINUTES (se existir no .env)
  // é ignorado de propósito: o timer apagava o texto que o atendente ainda digitava.
