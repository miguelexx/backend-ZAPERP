...
| atendimento sem resposta | 1 min / 35 s | gera/atualiza alertas e sockets. Lógica em `services/atendimentoSemResposta/` (fachada `atendimentoSemRespostaService.js`). Invariantes: [19](19-ATENDIMENTO-SEM-RESPOSTA-MODULARIZACAO.md). |
